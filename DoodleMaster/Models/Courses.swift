...
let multistep = TaskStep(brushName: "pencil", brushOpacity: 0.8, clearBefore: false, showResult: false)
let multistepFirst = TaskStep(brushName: "pencil", brushOpacity: 0.8, showResult: false)
...
let lines = Course(
    ...
    tasks: [
        Task(name: "Straight lines", path: "Lines/1", steps: [TaskStep](repeating: TaskStep(), count: 11)),
        ...
        Task(name: "Shapes", path: "Lines/8", steps:
                [TaskStep](repeating:  TaskStep(), count: 5) +
